...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-05 03:26 UTC*

### Отчёт о прокси-серверах
Текущий список прокси-серверов насчитывает 112 записей, с преобладанием хороших прокси-серверов в регионах Европы, США и России. Большинство прокси-серверов поддерживают протокол mtproto.

### Рекомендации
Рекомендуется использовать прокси-серверы из регионов Европы (`eu`), США (`us`) и России (`ru`), поскольку они имеют высокий процент хороших прокси-серверов (100%) и низкий средний пинг (0,07-0,1 секунды). Тип прокси-серверов `mtproto` также рекомендуется использовать.

### Аномалии
Обнаружено, что 12 прокси-серверов имеют неизвестный регион и плохое качество, что может указывать на потенциальные проблемы с их использованием. Рекомендуется избегать использования этих прокси-серверов.
