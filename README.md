...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 10:09 UTC*

### Отчёт о прокси-серверах
В настоящее время в списке прокси-серверов насчитывается 107 записей, распределённых по различным регионам и типам. Ниже представлена краткая аналитика данных для принятия обоснованных решений о выборе прокси.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона `'eu'`, где наблюдается наибольшее количество хороших прокси (52,13% от общего числа прокси в регионе) и относительно низкий средний пинг (2,16 с). По типу прокси предпочтение следует отдавать `'mtproto'` и `'socks5'`, которые представлены в списке в значительном количестве.

### Аномалии
Наблюдается значительное количество прокси-серверов с неизвестным регионом и качеством, что может указывать на необходимость дополнительной проверки и фильтрации. Кроме того, присутствуют прокси с высоким пингом (>5с), что может негативно повлиять на производительность.
