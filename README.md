...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-08 14:37 UTC*

### Отчёт о состоянии прокси-серверов
Текущий список прокси-серверов включает 112 записей, из которых 100 прокси имеют хорошее качество, с пингом менее 1,5 секунды. Большинство прокси расположены в регионе eu, с меньшим количеством в регионах ru и us.

### Рекомендации
Рекомендуется использовать прокси-серверы из регионов eu, ru и us, так как они демонстрируют высокий процент хороших прокси (100% в каждом регионе) и низкий средний пинг (0,1-0,13 секунды). Все прокси-серверы имеют тип mtproto.

### Аномалии
В списке присутствуют 12 прокси-серверов с неизвестным регионом и плохим качеством, что может указывать на потенциальные проблемы с их работой. Однако общее количество хороших прокси-серверов достаточно велико, чтобы можно было найти подходящий вариант.
