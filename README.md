...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-30 14:48 UTC*

### Отчёт о прокси-серверах
Текущий список прокси-серверов включает 112 записей с преобладанием хороших прокси-серверов с пингом менее 1,5 секунды. Региональный распределение прокси-серверов демонстрирует доминирование европейских прокси (eu) и относительно небольшое количество прокси из России (ru).

### Рекомендации
Рекомендуется использовать прокси-серверы из регионов 'eu' и 'ru', поскольку все они имеют высокое качество (пинг < 1.5с) и thuộc типу 'mtproto'. 

### Аномалии
Обнаружено 12 прокси-серверов с неизвестным регионом и качеством, помеченных как "плохие" (>5с), однако их доля относительно мала и не оказывает существенного влияния на общую статистику.

### Дата отчёта
Отчёт сформирован: 30 июня 2026 г.
<!-- AI_ANALYTICS_END -->