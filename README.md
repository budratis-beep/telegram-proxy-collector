...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-27 15:16 UTC*

### Отчёт о состоянии прокси-серверов
Текущий список прокси-серверов насчитывает 111 записей, распределённых по разным регионам и типам. Ниже представлены рекомендации и анализ данных.

### Рекомендации
На основе имеющихся данных рекомендуется использовать прокси-серверы из региона "eu" (Европа), которые демонстрируют лучшее качество работы (54,08% хороших прокси) и среднюю задержку 2,18 секунды. Что касается типа прокси, можно использовать как "mtproto", так и "socks5", поскольку их количество примерно равно.

### Аномалии
Присутствует заметная доля прокси-серверов с неизвестным регионом ("unknown") и высокой задержкой, что может указывать на потенциальные проблемы при их использовании. Также стоит отметить, что в регионе "ru" (Россия) представлен только один прокси-сервер, который не относится к категории хороших.
