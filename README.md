...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-29 10:07 UTC*

### Отчёт о состоянии прокси-серверов
Текущее состояние списков прокси-серверов насчитывает 93 прокси,分布енных по различным регионам и типам. Ниже приведены основные рекомендации и статистика.

### Рекомендации и статистика
На основе имеющихся данных рекомендуется использовать прокси-серверы из региона `eu`, поскольку они демонстрируют наиболее высокий процент хороших прокси (50,65%) и относительно низкую среднюю задержку (2,37 секунды). Для типа прокси рекомендуется выбирать `mtproto`, так как их количество превышает количество `socks5`.

### Аномалии
Наблюдается высокий процент прокси с неизвестным регионом (12 штук), которые не демонстрируют хороших показателей. Также стоит отметить, что регион `ru` имеет низкий процент хороших прокси.
