...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-30 20:28 UTC*

## Отчёт о прокси-серверах
Текущий список прокси-серверов содержит 112 записей, из которых 100 имеют хорошее качество (пинг < 1,5 секунд). Большинство прокси-серверов расположены в регионе Европы (92 шт.) и поддерживают протокол mtproto.

Рекомендуется использовать прокси-серверы из регионов Европы (eu) и России (ru), поскольку они показывают 100% хороших прокси-серверов с низким пингом (0,07 секунд и 0,1 секунд соответственно). Все прокси-серверы имеют тип mtproto.

В списке обнаружено 12 прокси-серверов с неизвестным регионом и плохим качеством (>5 секунд), что может указывать на потенциальные проблемы с подключением. Будьте осторожны при использовании этих прокси-серверов.

Отчёт сгенерирован: 30 июня 2024 00:00
<!-- AI_ANALYTICS_END -->