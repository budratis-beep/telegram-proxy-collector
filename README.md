...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-30 23:43 UTC*

### Отчёт о прокси-серверах
Текущее состояние списков прокси-серверов включает в себя 112 записей, с преобладанием хороших прокси-серверов с пингом менее 1,5 секунды. Большинство прокси-серверов расположены в регионе EU и поддерживают тип соединения mtproto.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона EU, поскольку они демонстрируют 100% уровень хороших прокси-серверов с средним пингом 0,09 секунды. Прокси-серверы из региона RU также могут быть использованы, но их количество значительно меньше.

### Предупреждения
Обнаружено 12 плохих прокси-серверов с пингом более 5 секунд, все они расположены в неизвестном регионе. Использование этих прокси-серверов не рекомендуется.
