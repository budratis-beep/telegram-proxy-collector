...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-07-09 08:12 UTC*

### Отчёт о состоянии списков прокси-серверов
Текущее состояние списков прокси-серверов включает в себя 112 прокси, из которых 100 являются хороших по качеству (пинг < 1.5с) и 12 прокси имеют плохое качество (>5с). Основная часть прокси-серверов расположена в регионе 'eu' и имеет тип 'mtproto'.

### Рекомендации
Для оптимальной работы рекомендуется использовать прокси-серверы из регионов 'eu', 'ru' и 'us', поскольку они имеют высокий процент хороших прокси (100%) и низкий средний пинг (0.07–0.09с). Все прокси-серверы имеют тип 'mtproto'.

### Предупреждение
Нет значительного количества плохих прокси-серверов в регионах 'eu', 'ru' и 'us', но 12 прокси-серверов имеют неизвестный регион и плохое качество, что может указывать на потенциальные проблемы с их использованием.
