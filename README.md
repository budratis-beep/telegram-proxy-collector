...
<!-- AI_ANALYTICS_START -->
*Отчёт сгенерирован 2026-06-28 07:56 UTC*

### Отчёт о состоянии прокси-серверов
Текущий список прокси-серверов насчитывает 112 записей, с разбивкой по качеству и регионам. Анализ данных показывает, что большая часть прокси-серверов находится в регионе 'eu' и имеет тип 'mtproto' или 'socks5'.

### Рекомендации
Рекомендуется использовать прокси-серверы из региона 'eu', поскольку они демонстрируют более высокий процент хороших прокси (45.36%) и относительно низкий средний пинг (2.44с). По типу прокси, 'mtproto' и 'socks5' имеют примерно равное распределение, но 'mtproto' имеет немного большее количество хороших прокси.

### Аномалии
Обнаружено, что в регионе 'unknown' все прокси-серверы имеют очень высокий пинг (999.0с) и не являются пригодными для использования. Также в регионе 'ru' наблюдается низкий процент хороших прокси (0.0%), что может указывать на необходимость проверки и обновления списка прокси-серверов в этом регионе.

### Дата и время отчёта
Отчёт сформирован: 28 июня 2026 г. 00:00
<!-- AI_ANALYTICS_END -->